                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail1-to show-up avail-to-width" name="availability[availability_1][to]" data-avail="avail1-from">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail2-to show-up avail-to-width" name="availability[availability_2][to]" data-avail="avail2-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail3-to show-up avail-to-width" name="availability[availability_3][to]" data-avail="avail3-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail4-to show-up avail-to-width" name="availability[availability_4][to]" data-avail="avail4-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail5-to show-up avail-to-width" name="availability[availability_5][to]" data-avail="avail5-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail6-to show-up avail-to-width" name="availability[availability_6][to]" data-avail="avail6-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-xs-6">
                                                        <div class="input-group">
                                                            <select class="form-control avail-to avail7-to show-up avail-to-width" name="availability[availability_7][to]" data-avail="avail7-from">
                                                                <?php echo $str_avail_to; ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-7 text-center">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <button class="btn btn-success upload-result_profile col-md-3" style="margin: 0px 20px;padding: 7px 7px;" id="crop_img_profile">Upload</button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <button class="btn btn-success upload-result col-md-2" style="margin: 0px 20px;padding: 7px 7px;"  id="crop_img">Upload</button>
                                                                    ...
                                                                    $(".frm_cook_registration").smartWizard({
                                                                        ...
                                                                        onShowStep: function (obj) {
                                                                            ...
                                                                            if (step == 1 || step == 2 || step == 3) {
                                                                                $(".actionBar .btn-primary.pull-right").css('display', 'none');
                                                                                $(".actionBar .btn-default.pull-right").css('display', 'block');
                                                                            } else {
                                                                                $(".actionBar .btn-primary.pull-right").css('display', 'block');
                                                                                $(".actionBar .btn-default.pull-right").css('display', 'none');
                                                                            }
                                                                            return true;
                                                                        }//End

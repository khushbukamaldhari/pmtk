	  ...
	  <div class="panel-body">
	  	<div class="row">
	  		...
	  		<div class="col-md-12" style="padding-top:30px;">
				<strong class="col-md-2">Select Image:</strong>
				<input class="col-md-3" type="file" id="upload">
				<button class="btn btn-success upload-result col-md-3">Crop Image</button>
	  		</div>
	  		<div class="col-md-12" style="">
				<div id="upload-demo-i" style="background:#e1e1e1;width:870px;padding:30px;height:400px;margin-top:30px"></div>
	  		</div>
	  	</div>

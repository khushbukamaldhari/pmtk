<div class='col-md-12 side-section'>
    <form action="#" method="post" id="frm_search_location" name="frm_search_location">
        <div class='col-md-12 '>
            <div>
                <h4 class="">Your Location</h4>
                <div class="form-group clearfix">
                    <div class="col-md-12 col-sm-6 col-xs-12 no-padding">
                        <input type="text" class="form-control" id="txt_location" name="txt_location" placeholder="Type Your Location Here" />
                    </div>
                </div>
                <div class="form-group clearfix">
                    <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                        <h5 class="hd-5">Select Your Location</h5>
                        <div class="col-md-12 col-sm-12 col-xs-12 div-ctry">
                            ...
                            <a class="lnk-pink" data-country="<?php echo $ctry['in_country_id']; ?>" href="#">
                                <div class="col-md-6 col-sm-6 col-xs-6 no-padding"><?php echo $ctry['st_country_name']; ?></div>
                            </a>
                            <?php } ?>
                        </div>
                    </div>
